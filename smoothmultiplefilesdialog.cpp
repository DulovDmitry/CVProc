...
SmoothMultipleFilesDialog::SmoothMultipleFilesDialog(QHash<QTreeWidgetItem *, GraphData *> *_hash, QWidget *parent) :
    QDialog(parent),
...
void SmoothMultipleFilesDialog::fillComboBox()
{
    ...
    ui->comboBox->addItem(CVCurveData::PlotTypes.at(CVCurveData::I_vs_T));
...
{
    CVCurveData::PlotType plotType = static_cast<CVCurveData::PlotType>(CVCurveData::PlotTypes.indexOf(ui->comboBox->currentText()));
